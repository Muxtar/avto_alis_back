  ...
  try {
    ...
    const listing = await prisma.listing.update({
      ...
      data: {
        ...
        ...(city !== undefined && { city: city || null }),
        ...(req.body.latitude !== undefined && { latitude: req.body.latitude !== '' && req.body.latitude != null ? parseFloat(String(req.body.latitude)) : null }),
        ...(req.body.longitude !== undefined && { longitude: req.body.longitude !== '' && req.body.longitude != null ? parseFloat(String(req.body.longitude)) : null }),
