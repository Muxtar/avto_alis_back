...
import professionDiscountRoutes from './routes/professionDiscount';
import proGroupRoutes from './routes/proGroups';
...
app.use('/api', professionDiscountRoutes);
app.use('/api', proGroupRoutes);
